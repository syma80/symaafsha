                ...
                <div className="content-container">
                    ...
                    <div className={`content ${getActiveClass(3, "active-content")}`}>
                        ...
                        <ul style={{fontSize: 20}}>
                            <li>
                                Coursera on Fundamentals of Digital Image and Video Processing Certified by Northwestern University. ( <a style={{ color:"yellow" , textDecoration: "none"}}href="https://www.coursera.org/account/accomplishments/verify/JE5BXT6HBWYL?utm_source=link&utm_medium=certificate&utm_content=cert_image&utm_campaign=sharing_cta&utm_product=course" target="_blank"><i>See Certificate</i></a> )
                            </li>
                            <li>
                                Coursera on Front-End Web UI Frameworks and Tools: Bootstrap 4 Certified by Hong Kong University Of
                                Science And Technology. ( <a style={{ color:"yellow", textDecoration: "none"}}href="https://www.coursera.org/account/accomplishments/verify/P9QGGCGMB3DA?utm_source=link&utm_medium=certificate&utm_content=cert_image&utm_campaign=sharing_cta&utm_product=course" target="_blank"><i>See Certificate</i> </a> )
                            </li>
                            <li>
                                Coursera on Programming Foundations with JavaScript, HTML and CSS Certified by Duke University. ( <a style={{ color:"yellow" , textDecoration: "none"}}href="https://www.coursera.org/account/accomplishments/verify/8CT7BK7G9XQL?utm_source=link&utm_medium=certificate&utm_content=cert_image&utm_campaign=sharing_cta&utm_product=course" target="_blank"><i>See Certificate</i></a> )
                            </li>
                            <li>
                                Coursera on Build Your Portfolio Website with HTML and CSS Certified by Coursera Project Network. ( <a style={{ color:"yellow"}}href="https://www.coursera.org/account/accomplishments/verify/R4MLRNUFTF96?utm_source=link&utm_medium=certificate&utm_content=cert_image&utm_campaign=sharing_cta&utm_product=project" target="_blank"><i>See Certificate</i></a> )</li>
                            <li> Python Starter Pack Workshop Certified by MIST Innovation Club with support of e-learning partner ohubrihi
                                Online Courses. ( <a style={{ color:"yellow"}}href="https://drive.google.com/file/d/1yzZqckoRtcd7wrn8t3jVamlPieexWH5b/view" target="_blank"><i>See Certificate</i></a> )
                            ...
                            <li>Introduction to Flutter Development Using Dart Certified by The App Brewery. ( <a style={{ color:"yellow"}}href="https://drive.google.com/file/d/1ZZfxpIc_e7bz2sU8oW7-WfOyYXvl2Aq7/view" target="_blank"><i>See Certificate</i></a> )</li>
                        </ul>
